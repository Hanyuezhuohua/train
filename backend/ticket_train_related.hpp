...
namespace sjtu{
	...
	public:
		...
		priority_queue<ticket_train, cmp_time> query_ticket_time(const STATIONS &station1, const STATIONS &station2, const string<5> &date){
	        ...
	        STATIONS tmpstation1 = iter1.get_key().get_station();
	        STATIONS tmpstation2 = iter2.get_key().get_station();
		...
		priority_queue<ticket_train, cmp_price> query_ticket_price(const STATIONS &station1, const STATIONS &station2, const string<5> &date){
